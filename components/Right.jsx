...
const Right = ({ images, selectedStoleId }) => {
          ...
          <div className={`border
           border-gray-400 border-opacity-30 
            ...
            <select
              ...
              className="w-[15.5rem]  text-sm text-gray-400 cursor-pointer  group-hover:block focus:outline-none border-gray-300 bg-gray-100 p-2 "
            >
          ...
          flex-row gap-x-1 items-center
           bg-white p-1 border border-gray-400 border-opacity-50 rounded-sm ${focus && 'border border-gray-700'}`} >
              <input
                ...
                className="font-custom outline-none bg-transparent w-[17rem] text-sm p-1.5 " />
            ...
            <div className="mt-3 flex flex-row gap-x-1 items-center bg-white p-1 border border-gray-400 border-opacity-50 rounded-sm" >
              <input disabled type="text" placeholder="Please select a stole223..." onChange={(e) => setSearchTerm(e.target.value)} className="font-custom outline-none bg-transparent w-[17rem] text-sm p-1.5 " />
            </div>
          )
        }
      </div>
                  ...
                  {searchQuery === '' ? (
                    ...
                    symbolsData.map(({ id, img, title }) => (
                      <div key={id} className=' flex flex-col items-center  hover:bg-white hover:transition-all hover:duration-100 hover:border-2 hover:border-gray-300 cursor-pointer bg-[#f5f5f5] rounded-lg  h-24 p-2'>
                        ...
                        <span className=' text-center text-xs pt-3 w-[5rem]'>{title}</span>
                      </div>
                    ))
              ...
              <div className='p-2 h-[460px] overflow-y-scroll'>
                {
                  searchQuery === '' ? (
                    ...
                    symbolsData.map(data => (
                      <div className='  flex p-2 mt-3 bg-[#f5f5f5] rounded-lg flex-row items-center  hover:transition-all  cursor-pointer'>
