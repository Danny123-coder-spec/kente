      ...
      <div className=" bg-[#f5f5f5]  object-center ">
        ...
        <div className="flex flex-row items-center p-2 justify-center gap-x-[2.8rem]  border border-gray-300 border-opacity-30">
          ...
          <div className="flex font-custom flex-row items-center gap-x-1">
            <div className="cursor-pointer border border-gray-500 border-opacity-50 px-6 py-1.5 rounded-md bg-white ">
          ...
          <div className="flex flex-col">
            <div ref={socialRef} onClick={handlePopUp} className="font-custom cursor-pointer flex flex-row items-center gap-x-2 rounded-md px-4 py-2 bg-yellow-400">
                ...
                <div className="w-[14.8rem] z-10 absolute right-[18.5rem] p-3 top-12 transform translate-x-1/2 bg-white border rounded shadow-lg">
                  ...
                  <div className="flex flex-row items-center gap-x-6">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[0.5rem] font-custom mt-[0.2rem]">Download</span>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[0.5rem] font-custom mt-[0.2rem]">facebook</span>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[0.5rem] font-custom mt-1">linkedin</span>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[0.5rem] font-custom mt-1">X</span>
                    </div>
                  </div>
                </div>
              )
          ...
          <Link to='/' className="font-custom  px-5 py-1.5 rounded-md bg-yellow-400 ">
